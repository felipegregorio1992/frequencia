...
const navItems: {
  ...
  { to: '/disciplinas', label: 'Disciplinas', icon: BookOpen, roles: ['ADMINISTRADOR'] },
  { to: '/turmas', label: 'Turmas', icon: School, roles: ['ADMINISTRADOR'] },
  { to: '/matriculas', label: 'Matrículas', icon: UserCheck, roles: ['ADMINISTRADOR'] },
  { to: '/matriculas-turmas', label: 'Alunos / Turmas', icon: Users2, roles: ['ADMINISTRADOR'] },
